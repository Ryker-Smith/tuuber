...
sub sendEmail{
  ...
  my $message="\nClick <a href=\"https://fachtnaroe.net/tuuber?cmd=verify&email=$email&string=$verificationString&pID=$pID\">here to validate your túber account email</a> address.\n";
...
sub verifyEmail{
  ...
  if  ($string_from_db eq $verificationString) {
    ...
    print "<h1>Sorry.</h1><h2>You did something wrong..</h2><br>(The latest version of the App will be <a href=\"https://fachtnaroe.net/apks/\">available here</a>)";
  }
}
...
<span>
<a href="https://fachtnaroe.net/apks/CoverSheetGenerator_013.apk">($version)There's a new version available</a>
</span>
__MSG_END
  return $html;
}
